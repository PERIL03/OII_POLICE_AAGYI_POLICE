...
export const KNOWN_EXCHANGE_TAGS: ExchangeTag[] = [
  // Binance
...
export function getExchangeTag(address: string, chain: 'BTC' | 'ETH'): ExchangeTag | null {
  const match = KNOWN_EXCHANGE_TAGS.find(
